...
|0.0.4-SNAPSHOT
| https://drive.google.com/file/d/18Y-ojhn9OmDYUv0j5gFkfolmpblVcOtb/view?usp=sharing[pptx, window=_blank] or https://drive.google.com/file/d/1js7Yqjh8TtBxW6nIkCaGmwOEwAmZM9Yr/view?usp=sharing[pdf, window=_blank]
|2020-11-14
|🇪🇸
...
* https://github.com/MasterCloudApps-Projects/AsyncReactiveProgramming/tree/master/examples/01-basic-comparison[Example 02. *Using Spring WebClient*]: Basic API to retrieve information from a remote web service using the reactive WebClient
