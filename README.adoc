...
|0.0.7-SNAPSHOT
| https://drive.google.com/file/d/11ktXhwVvWYnQTgHdmgKnT5UaZLGR-qba/view?usp=sharing[pptx, window=_blank] or https://drive.google.com/file/d/11MewvhhIz4v1WtHHQa30_aZeL4iMadLV/view?usp=sharing[pdf, window=_blank]
|2020-11-20
|🇪🇸
